...
export DOCKER_PASSWORD="<insert docker password>"
export DOCKER_EMAIL="bonkyun@gmail.com"

# SSP Access Credential.. Please put your user name and credential (access token)

export SSP_USERNAME="tony.liang@broadcom.com"
export SSP_CREDENTIAL="<insert secret>"
